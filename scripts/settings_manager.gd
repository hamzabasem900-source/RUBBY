...
func text(key: String) -> String:
	...
	var english := {
		...
		"skin_sky_name": "Sky Hopper",
		"skin_sky_desc": "A breezy blue bunny for quick cloud-light hops.",
		"skin_berry_name": "Berry Bunny",
		"skin_berry_desc": "A berry-colored bunny with a sweet strawberry badge.",
		"skin_cocoa_name": "Cocoa Runner",
		"skin_cocoa_desc": "A warm cocoa bunny with a slightly bigger trail-running shape.",
	...
	var arabic := {
		...
		"skin_sky_name": "أرنب السماء",
		"skin_sky_desc": "أرنب أزرق خفيف مناسب للقفزات السريعة.",
		"skin_berry_name": "أرنب التوت",
		"skin_berry_desc": "أرنب بلون التوت مع شارة فراولة لطيفة.",
		"skin_cocoa_name": "أرنب الكاكاو",
		"skin_cocoa_desc": "أرنب دافئ بلون الكاكاو وحجم مناسب للجري.",
