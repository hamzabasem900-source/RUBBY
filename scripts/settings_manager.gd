...
func text(key: String) -> String:
	...
	var english := {
		...
		"skin_shop_subtitle": "Spend saved carrots on new looks, then equip your favorite.",
		...
		"skin_meadow_name": "Meadow Scout",
		"skin_meadow_desc": "A green leafy style for sneaking past thorn bushes.",
		"skin_rose_name": "Rose Hopper",
		"skin_rose_desc": "A cheerful pink outfit inspired by spring flowers.",
		"skin_golden_name": "Golden Carrot",
		"skin_golden_desc": "A premium shiny skin for true carrot collectors.",
		"skin_night_name": "Moonlight Bunny",
		"skin_night_desc": "A calm midnight look with a glowing moon badge.",
	...
	var arabic := {
		...
		"skin_shop_subtitle": "اصرف الجزر المحفوظ على أشكال جديدة ثم اختر المفضل لديك.",
		...
		"skin_meadow_name": "كشاف المرج",
		"skin_meadow_desc": "شكل أخضر ورقي للتسلل قرب شجيرات الشوك.",
		"skin_rose_name": "قفزة الورد",
		"skin_rose_desc": "زي وردي مبهج مستوحى من زهور الربيع.",
		"skin_golden_name": "الجزر الذهبي",
		"skin_golden_desc": "سكن ذهبي لامع لهواة جمع الجزر الحقيقيين.",
		"skin_night_name": "أرنب ضوء القمر",
		"skin_night_desc": "شكل ليلي هادئ مع شارة قمر مضيئة.",
