...
func text(key: String) -> String:
	...
	var english := {
		...
		"skin_shop_subtitle": "Buy bunny shapes, then use the color dots to change each bunny color.",
		"skin_shop_hint": "White is free. Extra colors cost carrots for each bunny.",
		...
		"color_not_enough": "Not enough carrots for this color.",
		"color_unlock_skin_first": "Choose or buy this bunny before changing its color.",
		"color_selected_status": "Color selected: {color}.",
		"color_selected_tooltip": "Selected color: {color}",
		"color_owned_tooltip": "Use color: {color}",
		"skin_white_name": "Classic Bunny",
		"skin_white_desc": "The original bunny look. Colors can change later.",
		...
		"white_bunny": "Classic Bunny 🐰",
		"brown_bunny": "Runner Bunny 🐇",
	...
	var arabic := {
		...
		"skin_shop_subtitle": "اشتر اشكال الارانب ثم غير لون كل ارنب من نقاط الالوان.",
		"skin_shop_hint": "اللون الابيض مجاني وباقي الالوان تحتاج جزر لكل ارنب.",
		...
		"color_mint": "اخضر",
		"color_price": "{color}: {price} 🥕",
		"color_not_enough": "الجزر غير كاف لهذا اللون.",
		"color_unlock_skin_first": "اختر او اشتر هذا الارنب قبل تغيير لونه.",
		"color_selected_status": "تم اختيار اللون: {color}.",
		"color_selected_tooltip": "اللون المختار: {color}",
		"color_owned_tooltip": "استخدم اللون: {color}",
		"skin_white_name": "الكلاسيكي",
		"skin_white_desc": "شكل الارنب الاساسي ويمكن تغيير لونه لاحقا.",
		...
		"white_bunny": "الأرنب الكلاسيكي 🐰",
		"brown_bunny": "الأرنب القافز 🐇",
