...
func text(key: String) -> String:
	...
	var english := {
		...
		"skin_snow_name": "Snow Bunny",
		"skin_snow_desc": "A bright white bunny look for a clean garden run.",
		...
		"brown_bunny": "White Bunny 🐰",
		"white_bunny_button": "⬜ White Bunny",
		"brown_bunny_button": "⬜ White Bunny",
	...
	var arabic := {
		...
		"skin_snow_name": "الابيض",
		"skin_snow_desc": "ارنب ابيض لطيف للحديقة.",
		...
		"brown_bunny": "الأرنب الأبيض 🐰",
		"white_bunny_button": "⬜ الأرنب الأبيض",
		"brown_bunny_button": "⬜ الأرنب الأبيض",
