...
func _create_skin_card(skin: Dictionary) -> PanelContainer:
	...
	card.custom_minimum_size = Vector2(390, 154)
...
func _refresh_shop_cards() -> void:
	...
	for skin in GameManager.get_skin_catalog():
		...
		icon_label.text = _skin_icon_text(skin)
		icon_label.add_theme_font_size_override("font_size", _skin_preview_font_size(skin))
