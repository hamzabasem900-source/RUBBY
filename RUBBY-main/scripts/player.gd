...
const SPOTTED_BUNNY_SHEET_PATH: String = "res://assets/images/spotted_bunny_sprite_sheet.png"
...
func _animate_bunny(delta: float, dir: Vector2, dash_active: bool) -> void:
	...
	_set_bunny_visual_transform(
		hop,
		stride_squash + landing_squash,
		direction_lean + vertical_lean,
		forward_offset
	)
